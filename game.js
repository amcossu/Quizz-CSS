...
var g13A1 = document.querySelector("#g13answer1");
var g13A2 = document.querySelector("#g13answer2");
var g13A3 = document.querySelector("#g13answer3");
var g13A4 = document.querySelector("#g13answer4");

var g13divQuestion = document.querySelector("#g13question");

// function to start the game
g13startgame();

setTimer(10,g13result);

resetGameTitle("QUIZZ CSS");
...
function g13getRandomQA() {
    //output reinit
    g13A1.parentElement.classList.remove("bg__false-answer");
    g13A1.parentElement.classList.remove("bg__true-answer");
    g13A2.parentElement.classList.remove("bg__false-answer");
    g13A2.parentElement.classList.remove("bg__true-answer");
    g13A3.parentElement.classList.remove("bg__false-answer");
    g13A3.parentElement.classList.remove("bg__true-answer");
    g13A4.parentElement.classList.remove("bg__false-answer");
    g13A4.parentElement.classList.remove("bg__true-answer");

    document.querySelector('.progress-bar').classList.remove("paused");// restart progressbar

    var g13ProgressBar=document.querySelector('.progress-bar');// put progressbar in var
    ...
    progress.appendChild(g13ProgressBar);// push in html progressbar
    ...
    if (g13round == 10) {
        ...
        g13A1.parentElement.classList.add("btn_hover");
        g13A2.parentElement.classList.add("btn_hover");
        g13A3.parentElement.classList.add("btn_hover");
        g13A4.parentElement.classList.add("btn_hover");
...
function g13result() {
    ...
    switch (g13indexFound) {
        case 1:
            g13A1.parentElement.classList.add("bg__true-answer");
            break;
        case 2:
            g13A2.parentElement.classList.add("bg__true-answer");
            break;
        case 3:
            g13A3.parentElement.classList.add("bg__true-answer");
            break;
        case 4:
            g13A4.parentElement.classList.add("bg__true-answer");
            break;
    }
    ...
    // go to next question
    setTimeout(g13getRandomQA, 2000);

    g13A1.parentElement.classList.remove("btn_hover");
    g13A2.parentElement.classList.remove("btn_hover");
    g13A3.parentElement.classList.remove("btn_hover");
    g13A4.parentElement.classList.remove("btn_hover");
